...
go build -tags with_grpc,with_clash_api,with_v2ray_api,with_utls,with_reality_server,with_gvisor,with_quic -o $PROJECT/latinaserver $PROJECT/cmd/latinaserver/main.go
