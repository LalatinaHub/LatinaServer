/**
 * QRCode.js - Pure JavaScript QR Code Generator (Standalone / Zero Dependencies)
 * Supports canvas and table rendering.
 */
(function(global){
...
var QRCode=function(el,vOption){
  ...
  if(typeof vOption==='string'){this._htOption.text=vOption;}else if(vOption){for(var i in vOption){this._htOption[i]=vOption[i];}}
...
QRCode.prototype.makeCode=function(sText){
  ...
  var nWidth=Math.round(this._htOption.width/nCount);
  var nHeight=Math.round(this._htOption.height/nCount);
  this._el.innerHTML="";
  ...
  for(var r=0;r<nCount;r++){
    for(var c=0;c<nCount;c++){
      if(this._oQRCode.isDark(r,c)){
        ctx.fillRect(c*nWidth,r*nHeight,nWidth,nHeight);
      }
    }
  }
